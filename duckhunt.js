...
// let divDuck = document.createElement('div')

// divDuck.classList.add("duck")
  
// body.appendChild(divDuck)
...
function moveDuck(duck){
    ...
    else if (duckLeft < window.innerWidth /2){
...
function randomLocation(duck){
  let startNum = (Math.random() * window.innerWidth)  
...
function createDuck(){
  ...
  newDuck= newDuck.cloneNode(false)
...
//     ducks[i].addEventListener('mouseover', addShot)
// }
